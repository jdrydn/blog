...
description:
  "After reading this excellent article about now Netflix handles scaling & versioning, and also from experience, it's
  safe to say that writing a versioned API is a pain."
date: 2016-07-04
---
...
version the incoming requests accordingly, and offers a solution to control your logic across API versions 😎

Rather than sending versions from your clients & having complicated if-statements throughout your codebase
(`IF version >= 100 AND version < 200`) instead you have a simpler way to compare versions.
