...
date: 2016-02-16
permalink: /posts/2016-02-16-telegram-hero/
---
...
/**
 * If you don't want to use `:bot_name` or `:bot_auth` as params, you can instruct
 *   the middleware to use different ones like this example shows:
 *
 * /webhook/amazing-bot/4b238abe064c9d6c860e386d8cbf8cd2
 */
app.post(
