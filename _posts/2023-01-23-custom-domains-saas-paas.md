...
date: 2023-01-23
permalink: /posts/2023-01-23-custom-domains-saas-paas/
---
...
![](/assets/images/posts/2023-01-23-custom-domains-saas-paas/image1.png)
...
- We could use the Full SSL mode to ensure traffic between Cloudflare & Cloudfront communicate over HTTPS ✅

![](/assets/images/posts/2023-01-23-custom-domains-saas-paas/image2.png)

> Encrypts end-to-end, using a self signed certificate on the server.

- And if we went the extra mile to Strict SSL mode, we could use a Cloudflare Origin (Self-Signed) Certificate 🔒

![](/assets/images/posts/2023-01-23-custom-domains-saas-paas/image3.png)
